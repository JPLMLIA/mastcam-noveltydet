...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', nargs="?", choices=['mnist', 'kdd', 'mcam'], help='the name of the dataset you want to run the experiments on')
    parser.add_argument('split', nargs="?", choices=['run', 'test'], help='train the example or evaluate it')
    parser.add_argument('--nb_epochs', nargs="?", type=int, help='number of epochs you want to train the dataset on')
    parser.add_argument('--label', nargs="?", help='label for results files')
